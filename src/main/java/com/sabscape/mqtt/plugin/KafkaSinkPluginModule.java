...
/**
 * Entry point for the Kafka sink plugin
 *
 * @author Sabarish Sasidharan
 */
@Information(name = "Kafka Sink Plugin", author = "Sabarish Sasidharan", version = "1.0.0")
public class KafkaSinkPluginModule extends HiveMQPluginModule {
